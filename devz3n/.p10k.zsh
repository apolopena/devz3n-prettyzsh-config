# Generated by Powerlevel10k configuration wizard on 2021-08-09 at 15:50 UTC.
# Also hand edited by Apolo Pena.
# Tested with the terminal font such MesloLGS NF which contains all the necessary glyphs.
...
# 12h time, slanted separators, sharp heads, slanted tails, 2 lines, solid, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%62F\u300B'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%208F\u300A'
